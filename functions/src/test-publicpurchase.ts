...
async function test() {
  console.log("🚀 Starting publicpurchase test with Browserbase...");
  ...
  console.log("  PUBLICPURCHASE_USER:", process.env.PUBLICPURCHASE_USER ? "✓ Set" : "✗ Missing");
  console.log("  PUBLICPURCHASE_PASS:", process.env.PUBLICPURCHASE_PASS ? "✓ Set" : "✗ Missing");
  ...
  try {
    const results = await publicpurchase(
      page,
      {
        ...
        DEV_PUBLICPURCHASE_USER: process.env.PUBLICPURCHASE_USER || process.env.DEV_PUBLICPURCHASE_USER,
        DEV_PUBLICPURCHASE_PASS: process.env.PUBLICPURCHASE_PASS || process.env.DEV_PUBLICPURCHASE_PASS,
