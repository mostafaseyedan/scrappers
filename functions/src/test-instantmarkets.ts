...
async function test() {
  console.log("🚀 Starting instantmarkets test with Browserbase...");
  ...
  console.log("  INSTANTMARKETS_USER:", process.env.INSTANTMARKETS_USER ? "✓ Set" : "✗ Missing");
  console.log("  INSTANTMARKETS_PASS:", process.env.INSTANTMARKETS_PASS ? "✓ Set" : "✗ Missing");
  ...
  try {
    const results = await instantmarkets(
      page,
      {
        ...
        DEV_INSTANTMARKETS_USER: process.env.INSTANTMARKETS_USER || process.env.DEV_INSTANTMARKETS_USER,
        DEV_INSTANTMARKETS_PASS: process.env.INSTANTMARKETS_PASS || process.env.DEV_INSTANTMARKETS_PASS,
