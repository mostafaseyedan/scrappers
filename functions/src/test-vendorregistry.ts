...
async function test() {
  console.log("🚀 Starting vendorregistry test with Browserbase...");
  ...
  console.log("  VENDORREGISTRY_USER:", process.env.VENDORREGISTRY_USER ? "✓ Set" : "✗ Missing");
  console.log("  VENDORREGISTRY_PASS:", process.env.VENDORREGISTRY_PASS ? "✓ Set" : "✗ Missing");
  ...
  try {
    const results = await vendorregistry(
      page,
      {
        ...
        DEV_VENDORREGISTRY_USER: process.env.VENDORREGISTRY_USER || process.env.DEV_VENDORREGISTRY_USER,
        DEV_VENDORREGISTRY_PASS: process.env.VENDORREGISTRY_PASS || process.env.DEV_VENDORREGISTRY_PASS,
