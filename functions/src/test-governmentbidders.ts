...
async function test() {
  console.log("🚀 Starting governmentbidders test with Browserbase...");
  ...
  console.log("  GOVERNMENTBIDDERS_USER:", process.env.GOVERNMENTBIDDERS_USER ? "✓ Set" : "✗ Missing");
  console.log("  GOVERNMENTBIDDERS_PASS:", process.env.GOVERNMENTBIDDERS_PASS ? "✓ Set" : "✗ Missing");
  ...
  try {
    const results = await governmentbidders(
      page,
      {
        ...
        DEV_GOVERNMENTBIDDERS_USER: process.env.GOVERNMENTBIDDERS_USER || process.env.DEV_GOVERNMENTBIDDERS_USER,
        DEV_GOVERNMENTBIDDERS_PASS: process.env.GOVERNMENTBIDDERS_PASS || process.env.DEV_GOVERNMENTBIDDERS_PASS,
